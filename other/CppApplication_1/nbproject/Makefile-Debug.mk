...
${OBJECTDIR}/boost_ql_testing.o: nbproject/Makefile-${CND_CONF}.mk boost_ql_testing.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/boost_ql_testing.o boost_ql_testing.cpp
